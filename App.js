...
import { BrowserRouter as Router, Routes, Route, Link } from 'react-router-dom'; // Use Routes and Route instead of Switch
import StatesPage from './FindBeaches-components/StatesPage';
import CitiesPage from './FindBeaches-components/Citiespage';
import BeachesPage from './FindBeaches-components/BeachesPage';
import './Home/App.css';
    ...
    <Router>
      <div className="App">
        ...
        <header>
          ...
          <nav>
            <ul>
              ...
              <li><Link to="/find-beaches">Find Beaches</Link></li>
        ...
        <Routes>
          ...
          <Route path="/find-beaches" element={<StatesPage />} />
          <Route path="/find-beaches/states/:stateId" element={<CitiesPage />} />
          <Route path='/find-beaches/states/:stateId/cities/:cityId' element={<BeachesPage />} />
        </Routes>
